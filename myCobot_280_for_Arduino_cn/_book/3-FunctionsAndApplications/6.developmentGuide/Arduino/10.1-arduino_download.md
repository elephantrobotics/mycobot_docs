...
下载 **Arduino IDE** 可以点击 [**Arduino 官网**](https://www.arduino.cc/en/software) 下载安装与电脑系统对应的版本，此处提供Arduino IDE 1.8.16版本下载链接，选择下方与自己开发环境相对应的系统，点击即可下载安装。如果在第五章初次使用时已经下载了，则此处无需重复下载。
...
![arduino](../../../resource/3-FunctionsAndApplications/6.developmentGuide/Arduino/build/10-1-4.1-003.png)
  ...
  * 点击下载相关依赖库
    - [**MycobotBasic**](https://github.com/elephantrobotics/MyCobotBasic/tags)(Mycobot280-Arduino机型导入后可以参考[库的使用](10.4-arduinolib_use.md)章节进行使用)。具体请看下图，.zip适用于Windows系统，.tar.gz适用于Linux系统：<br>
    [下载 windows系统依赖库](MyCobotBasic-0.0.1.zip)<br>
    [下载 Linux系统依赖库](MyCobotBasic-0.0.1.tar.gz)
