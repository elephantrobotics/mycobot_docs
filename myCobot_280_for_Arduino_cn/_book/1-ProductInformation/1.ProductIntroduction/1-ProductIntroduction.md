...
myCobot 280 For Arduino 采用 ATOM Matrix ESP32 Development Kit 核心开发板作为主控。搭载大象机器人自主研发的机器人运动控制操作系统固件，内置运动学正逆解。支持搭配多种Arduino开发版，进行扩展应用开发。使用Arduino开发板搭配多种Arduino官方支持的传感器，可以快速构建机械臂 机器视觉与机器人应用、控制逻辑开发、机器人融合开发、ROS仿真实验课堂的首选助手，帮助您快速开始六轴机械臂学习与应
