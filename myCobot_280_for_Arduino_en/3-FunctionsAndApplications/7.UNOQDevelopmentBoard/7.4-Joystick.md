...
The full source code is listed in this section so that the PDF version can be used offline. The same script is also kept in `example/debian/myCobot280_unoq_handle_control.py` for secondary development.
