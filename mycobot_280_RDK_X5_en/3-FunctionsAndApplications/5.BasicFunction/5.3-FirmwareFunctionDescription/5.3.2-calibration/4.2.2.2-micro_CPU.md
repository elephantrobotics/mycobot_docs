...
> **Note:** The file is named: rdkx5_mycobot_test_gui.py.
...
class MycobotTest(object):
    ...
    def stop_aging_test(self):
        try:
            ...
            os.system("sudo rm /home/sunriseaging_test.sh")
            os.system("sudo rm /home/sunriseDesktop/aging_test.py")
    ...
    def _aging_test(self):
        ...
        aging_test_content_sh = textwrap.dedent(
            """\
            #!/bin/bash
            /usr/bin/python3 /home/sunriseDesktop/aging_test.py
            """
        )
        ...
        aging_test_content_service = textwrap.dedent(
            ...
            Restart=on-failure
            RestartSec=2
            ExecStart=/home/sunriseaging_test.sh
            [Install]
        ...
        os.system(
            'echo "' + aging_test_content_py + '" >> /home/sunriseDesktop/aging_test.py'
        )
        os.system('echo "' + aging_test_content_sh + '" >> /home/sunriseaging_test.sh')
        os.system("sudo chmod +x /home/sunriseaging_test.sh")
        os.system(
            'echo "'
            + aging_test_content_service
            + '" >> /home/sunriseDesktop/aging_test.service'
        )
        os.system(
            "sudo mv /home/sunriseDesktop/aging_test.service /etc/systemd/system/aging_test.service"
        )
...
```bash
cd Desktop
python3 rdkx5_mycobot_test_gui.py
```
