...
- **Function:** Robot arm error detection
...
- **Return value:** 1- Robot arm is powered on 0 - Robot arm is powered off -1- Error
...
- **Function:** Let the robot arm pause the current movement
- **Return value:** None

**2.2** `stop()`

- **Function:** Let the robot arm stop all movements
- **Return value:** None

**2.3** `resume()`

- **Function:** Let the robot arm resume the previously set movement
- **Return value:** None

**2.4** `is_paused()`

- **Function:** Determine whether the robot arm is in a paused state
...
- **Parameter description:**
- `joint_id`: Represents the joint of the robot arm. The six-axis robot has six joints, so the length is 6, and the four-axis length is 4. There is a specific representation method.
The representation of joint 1: `Angle.J1.value` (can also be represented by numbers 1-6)
...
- **Function:** Send the potential value to all joints of the robot arm
- **Parameter description:**
- `encoder`: Represents the potential value of the robot arm, the value range is 0 ~ 4096, the length of the six axes is 6, the length of the four axes is 4, the representation method is: [2048,2048,2048,2048,2048,2048]
...
- **Function: ** Send radian values ​​to all joints of the robot
- **Parameter description: **
- `radians`: indicates the radian value of the robot
- **Return value: ** None
...
- **Parameter Description:**
- `degrees`: List of angle values ​​for each joint ( `List[float]`)
- `speed`: ( `int`) The speed of the robot movement, the value range is 0-100.
...
- **Parameter description:**
- `pin_no` (int): Specific pin number on the top of the robot
...
- **Function:** Set the working status of the end pin number
- **Parameter description:**
- `pin_no`(`int`) The number marked on the end of the device only takes the digital part
- `pin_signal`(`int`): Input 0 to set it to running state, input 1 to stop state
- **Return value:** None
...
- **Return value:** `pin_signal`(`int`) When the returned value is 0, it means running in the working state, and 1 means stopping state
...
- **Return value:**
- `0`: Indicates that the gripper of the robot is not running
- `1`: Indicates that the gripper of the robot is running
...
- `speed`: Indicates the speed of rotation, with a value range of 0~100
