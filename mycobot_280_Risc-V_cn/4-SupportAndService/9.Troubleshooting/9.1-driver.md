...
**Q：mycobot280-riscv的python拖动示教demo如何运行？**
- A：在终端运行，波特率请输入1000000。


**Q：mycobot280-RISCV用python零位校准demo程序，为什么会有误差？**
...
- A：基于微控制器的机械臂我们目前是在Ubuntu上，需要下载虚拟机搭建虚拟环境，在虚拟环境里安装Ubuntu系统来运行ROS，您也可以自己开发自己的ROS2。基于微处理器的机械臂是自带ROS2环境的，可以直接使用。


**Q：基于微处理器的机械臂是否可以连接pc来使用ros2呢？**

- A：目前的开源资料是没有直接通讯控制的，可以通过 ros2 + socket，修改现有的节点文件，进行实现。
...
**Q：使用ROS2启动rviz模型文件时，为什么会报错报错permission denied：'/dev/ttyUSB0'？**
