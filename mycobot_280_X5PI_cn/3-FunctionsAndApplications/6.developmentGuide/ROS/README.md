...
- 以上使用设备中，myCobot 280-Pi、myCobot 280-JetsonNano、myCobot 320-Pi、mechArm-270 PI等版本自带Ubuntu（V-20.04）系统，myCobot 280 RDKX5版本自带Ubuntu (V-22.04) 系统，已经内置了开发环境，所以无需搭建管理，直接使用即可。
