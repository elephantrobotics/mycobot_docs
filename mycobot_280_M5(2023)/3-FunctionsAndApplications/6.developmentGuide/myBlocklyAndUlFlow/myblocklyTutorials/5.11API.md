...
- **接口描述**: Get the radians of all joints.

- **返回**: `list`: A float list of radian.

### send_radians

- **原型**: `send_radians(radians, speed)`

- **接口描述**: Send the radians of all joint to robot arm.
...
- **原型**: `set_encoders(encoders, sp)`

- **接口描述**: Set the six joints of the manipulator to execute synchronously to the specified position.
...
- **接口描述**: Get the six joints of the manipulator.

- **返回**: the list of encoder (`list`) -->
...
- **接口描述**: Set the color of the light on the top of the robot arm.
...
- **原型**: `set_encoders_drag(encoders, speeds)`

- **接口描述**: Send all encoders and speeds
...
- **接口描述**: Init GPIO module, and set BCM mode.

### gpio_output

- **原型**: `gpio_output(pin, v)`

- **接口描述**: Set GPIO port output value.
...
- **接口描述**: Get the all serial port list.

- **Return**: serial port list (`list`)

## detect_port_of_basic

- **原型**: `detect_port_of_basic()`

- **接口描述**: Returns the serial port string of the first detected M5 Basic. If it is not found, it 返回s `None`.
...
- **原型**: `set_gpio_mode(mode)`

- **接口描述**: Set pin coding method.
...
- **原型**: `set_gpio_out(pin_no, mode)`

- **接口描述**: Set the pin as input or output.
...
- **原型**: `set_gpio_output(pin_no, state)`

- **接口描述**: Set the pin to high or low level.
...
- **原型**: `get_gpio_in(pin_no)`

- **接口描述**: Get pin level status.
