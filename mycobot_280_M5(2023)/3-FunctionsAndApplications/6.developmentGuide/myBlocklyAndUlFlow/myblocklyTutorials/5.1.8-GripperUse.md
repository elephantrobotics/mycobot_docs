...
+ 方法模块**1**：`重新初始化夹爪`
  ...
  <img src="../../resourse/5-ProgramingApplication-myblockly-uiflow-mind/image/myblockly/重新初始化夹爪.jpg" style="zoom: 80%;" />
...
- 方法模块**2**：`设置夹爪状态`
  ...
  <img src="../../resourse/5-ProgramingApplication-myblockly-uiflow-mind/image/myblockly/设置夹爪状态.jpg" style="zoom: 67%;" />
...
- 方法模块**3**：`设置夹爪的值`
  ...
  <img src="../../resourse/5-ProgramingApplication-myblockly-uiflow-mind/image/myblockly/设置夹爪的值.jpg" style="zoom: 67%;" />
...
* 方法模块**4**：`夹爪是否在运动`
  ...
  <img src="../../resourse/5-ProgramingApplication-myblockly-uiflow-mind/image/myblockly/夹爪是否在运动.jpg" style="zoom: 67%;" />
...
<img src="../../resourse/5-ProgramingApplication-myblockly-uiflow-mind/image/myblockly/夹爪demo.jpg" style="zoom: 50%;" />
